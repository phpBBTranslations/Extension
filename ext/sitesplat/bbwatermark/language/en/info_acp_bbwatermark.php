...
*
* @package BBwatermark
* @copyright (c) 2016 SiteSplat (https://sitesplat.com)
* @license Proprietary
*
*/
...
$lang = array_merge($lang, array(
	...
	'LOG_BBWATERMARK_INSTALLED'		=> '<strong>BBwatermark installed successfully</strong>',
	'LOG_BBWATERMARK_DEINSTALLED'	=> '<strong>BBwatermark uninstalled successfully</strong>',

	'LOG_BBWATERMARK_NOT_REPLACED'	=> '<strong>BBwatermark didn\'t uninstall successfully</strong><br />Could not replaced file(s)<br />» %s',
	'LOG_BBWATERMARK_NOT_UPDATED'	=> '<strong>BBwatermark didn\'t install successfully</strong><br />Could not update file(s)<br />» %s',
