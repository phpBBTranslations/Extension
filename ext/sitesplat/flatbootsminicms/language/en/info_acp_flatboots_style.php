...
$lang = array_merge($lang, array(
	'TRANSLATION_INFO'					=> 'Translated by <a href="https://sitesplat.com/">ThemeSplat</a>.',
	...
	'FLATBOOTS_STYLE_CSS'				=> 'Custom CSS',
	...
	'MENU_BUTTON_URL_EXPLAIN'	 		=> 'You can use URL address including https:// protocol or template variable such as {U_PRIVATEMSGS}. You can find available template variables in includes/functions.php file around line 4545',
	...
	'IMG_UPLOAD_EXPLAIN'        		=> 'Allowed extensions are png, jpg, svg, jpeg and gif.',
	'IMG_UPLOAD_ERROR'          		=> 'Only png, jpg, jpeg, svg and gif extensions are allowed.',
	...
	'MENU_LINK_URL'		       			=> 'URL',
	'MENU_LINK_URL_EXPLAIN'	 			=> 'You can use URL address including https:// protocol or template variable such as {U_PRIVATEMSGS}. You can find available template variables in includes/functions.php file around line 4545',
	...
	'MENU_SOCIAL_URL'		       		=> 'URL',
	'MENU_SOCIAL_URL_EXPLAIN'	 		=> 'You can use URL address including https:// protocol or template variable such as {U_PRIVATEMSGS}. You can find available template variables in includes/functions.php file around line 4545',
	...
	'SELECTED_FILE_EXPLAIN'				=> 'Please note, that submitting this form may alter your custom.css file in an&nbsp;unexpected way. Due to processing limitations, all slashes will be removed, and HTML special characters (as &amp;nbsp; and such) will be replaced by its original character. If you need more advanced editing, please, use FTP to edit file directly. You can find the file in styles/FLATBOOTS/theme/custom.css.',
